    ...
    <div className="mx-auto w-full max-w-2xl px-10 py-14 text-black dark:text-white">
      ...
      <section className="mb-8">
        ...
        <p className="leading-relaxed text-sm mb-4">
          The Daily Commit uses <strong>essential cookies only</strong>. These
          are strictly necessary for the site to function and cannot be switched
          off. They are set in response to actions made by you, such as signing
          in or adjusting preferences.
        </p>
              ...
              {[
                {
                  ...
                  duration: "7 days",
                  purpose:
                    "Stores your shopping cart items so they persist across page loads and sessions.",
                },
                {
                  name: "cookie_consent",
                  type: "Essential",
                  duration: "1 year",
                  purpose:
                    "Remembers your cookie preference so we do not ask again on every visit.",
                },
                {
                  name: "better-auth.*",
                  type: "Essential",
      ...
      <section className="mb-8">
        ...
        <p className="leading-relaxed text-sm">
          ...
          analytics cookies. No data about your browsing behaviour is shared
      ...
      <section className="mb-8">
        ...
        <p className="leading-relaxed text-sm">
          ...
          that disabling essential cookies may affect how the site functions —
          for example, you may not be able to stay signed in.
        </p>
        <p className="leading-relaxed text-sm mt-3">
          <strong>Essential cookies</strong> are set under the
          legitimate-interest basis of GDPR Article 6(1)(b) (necessary for the
          performance of a contract) and cannot be disabled without breaking
