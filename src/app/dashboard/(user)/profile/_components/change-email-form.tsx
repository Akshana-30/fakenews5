...
export default function ChangeEmailDialog({ currentEmail }: Props) {
 ...
 const [loading, setLoading] = useState(false);
  ...
  return (
    ...
    >
      <label className="font-heading text-base leading-snug font-medium">Email and Password</label>
      <div className=" flex flex-row gap-11"><span className="my-auto"><p className="text-black/60 font-semibold">{currentEmail}</p></span>
      <span><DialogTrigger className="my-auto" asChild>
        <Button variant="outline">Edit</Button>
      </DialogTrigger></span></div>
      ...
      <DialogContent className=" sm:max-w-sm">
        <DialogHeader>
          ...
          <DialogDescription>
            Enter your new email and current password. A verification email will be sent shortly.
          </DialogDescription>
        </DialogHeader>
