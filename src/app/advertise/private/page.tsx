...
import {
    Car, Anchor, Building2, Bike, Tv, Sofa, Baby,
    Shirt, Flower2, Package, Mail, CheckCircle2, ArrowRight,
} from "lucide-react";
...
const tiers = [
    ...
    },
    {
        ...
        price: "49 kr",
        duration: "60 days",
        features: ["Up to 5 photos", "Max 800 characters", "Highlighted in category listing"],
    },
    {
        name: "Featured",
        price: "99 kr",
        duration: "60 days",
        features: ["Up to 10 photos", "Max 1 500 characters", "Top placement + highlighted", "Shown on front page"],
    },
];
    ...
    return (
        <div className="h-full flex flex-col mx-auto w-full max-w-5xl px-6 pt-14 pb-16">
            ...
            <div className="mb-10">
                ...
                <h1 className="font-serif text-4xl font-bold tracking-wide">Private Ads</h1>
                <p className="mt-2 font-serif italic text-muted-foreground">
                    Sell it, find it, swap it — reach thousands of readers in Linköping and beyond.
                </p>
            ...
            <section className="mb-12">
                ...
                <p className="text-sm text-muted-foreground mb-4">Click a category to place your ad.</p>
                <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-3">
                    {CATEGORIES.map((cat) => (
                        ...
                        >
                            ...
                            <ArrowRight size={14} className="mt-1 text-muted-foreground group-hover:text-primary transition-colors shrink-0" />
                        </Link>
                    ))}
                </div>
            </section>
                ...
                <div className="grid gap-4 sm:grid-cols-3">
                    {tiers.map((tier) => (
                        ...
                        >
                            ...
                            <p className="font-serif text-3xl font-bold mb-0.5">{tier.price}</p>
            ...
            <section className="rounded-xl border p-6 bg-popover shadow-sm">
                ...
                <p className="text-sm leading-relaxed mb-4 max-w-2xl">
                    You can also send your ad text, price, photos, and contact details directly
                    to our classifieds desk.
                </p>
