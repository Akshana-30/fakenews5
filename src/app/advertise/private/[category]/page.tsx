    ...
    return (
        <div className="mx-auto w-full max-w-3xl px-6 pt-10 pb-16">
            ...
            <nav className="flex items-center gap-1 text-xs text-muted-foreground mb-8">
                <Link href="/advertise/private" className="hover:text-foreground transition-colors">
                    Classifieds
                </Link>
            ...
            <div className="mb-8">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                    Fill in the form below. Your ad will be reviewed and published within one business day.
                </p>
            </div>

            <AdForm categorySlug={cat.slug} subcategories={cat.subcategories} titlePlaceholder={cat.titlePlaceholder} />
        </div>
    );
}
