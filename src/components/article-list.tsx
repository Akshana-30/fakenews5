...
import Bookmark from "@/app/article/[articleID]/_components/bookmark";
import { hasUserBookmarkedArticle } from "@/_actions/article-actions";
  ...
  return (
    <div>
      <Card className="mb-2 pt-0!">
        ...
        <div className='flex justify-end mr-5'><BookmarkButton articleId={article.id} className="w-5"/></div>
